...
``` 
9. In the terminal, navigate to the `BRIDGES_for_CA` folder using "cd" commands. (Only if you copied the BRIDGES repository from a Windows computer to Sherlock: Run the command `dos2unix my_job.script` to convert the line break formatting of this file to unix style.)
